...
import com.functorz.worktool.config.GlobalException
import com.google.gson.Gson
import com.hjq.toast.ToastUtils
import com.tencent.wework.api.IWWAPI
import com.tendcloud.tenddata.TalkingDataSDK
import com.umeng.commonsdk.UMConfigure
import com.functorz.worktool.notification.PlayNotifyManager
import com.functorz.worktool.utils.IWWAPIUtil
import com.functorz.worktool.utils.LogUtilsInit
...
class MyApplication : Application() {
    ...
    override fun onCreate() {
        ...
        TalkingDataSDK.init(
            ...
            getString(R.string.app_name) + "_master",
            Constant.robotId
        )
        //初始化企业微信sdk
