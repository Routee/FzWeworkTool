...
object Constant {
    ...
    var weworkCorpId: String
        get() = SPUtils.getInstance().getString(Constant.weworkCorpName + "weworkCorpId", "")
        set(value) {
            SPUtils.getInstance().put(Constant.weworkCorpName + "weworkCorpId", value)
        }
    var weworkAgentId: String
        get() = SPUtils.getInstance().getString(Constant.weworkCorpName + "weworkAgentId", "")
        set(value) {
            SPUtils.getInstance().put(Constant.weworkCorpName + "weworkAgentId", value)
        }
    var weworkSchema: String
        get() = SPUtils.getInstance().getString(Constant.weworkCorpName + "weworkSchema", "")
        set(value) {
            SPUtils.getInstance().put(Constant.weworkCorpName + "weworkSchema", value)
        }
    var weworkMP: String
        get() = SPUtils.getInstance().getString(Constant.weworkCorpName + "weworkMP", "")
        set(value) {
            SPUtils.getInstance().put(Constant.weworkCorpName + "weworkMP", value)
        }
    ...
    var robotId: String
        get() = SPUtils.getInstance()
            .getString("robotId", SPUtils.getInstance().getString("LISTEN_CHANNEL_ID", ""))
        set(value) {
    ...
    private fun getBaseUrl() = host.replace(
        wssRegex, "https"
    ).replace(
        wsRegex, "http"
    )
